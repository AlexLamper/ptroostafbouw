...
const Hero = () => (
  <section className={`hero relative min-h-screen overflow-hidden flex justify-center items-center`} id='hero'>
    <div className="lg:max-w-[60%] flex justify-center items-center h-min mt-[-10rem] text-center">
      <div>
        <h2 className="text-4xl lg:text-5xl max-sm:text-2xl text-[#ededed]">afbouwbedrijf</h2>
        <h1 className="text-9xl lg:text-[110px] max-sm:text-7xl mb-12 leading-none font-medium text-[#ededed]">
          P. Troost
        </h1>
